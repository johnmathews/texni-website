"""
Django settings for texni_website project.
...
SECRET_KEY = 'mqxf7bm#9hy69q8_ln#kx^xyt6@&mcgvp%j*@n)0%z=%k$o1pl'
...
ROOT_URLCONF = 'texni_website.urls'
...
WSGI_APPLICATION = 'texni_website.wsgi.application'
